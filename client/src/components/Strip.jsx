...
const Strip = (props) => {
    ...
    if (props.isLoading) {
        return (
            <div className="flex bg-gray-800 w-full shadow-2xl rounded-xl h-24 animate-pulse">
        ...
        return (
            <div className='relative group' onMouseEnter={onMouseEnterHandler} onMouseLeave={onMouseLeaveHandler}>
                <Link to={"/game/" + props.slug} className="flex w-full shadow-2xl h-24 group cursor-pointer">
                    ...
                    <div className="bg-gray-800 group-hover:bg-gray-900 flex basis-11/12 rounded-e-xl ">
                        ...
                        <div className='flex justify-end basis-2/12 text-white font-bold text-lg rounded-e-xl'>
                            <div className='border-2 border-blue-500 me-12 my-auto px-5 py-1 rounded-lg'>{props.score}</div>
                ...
                <GameOptions isMouseOver={isMouseOver} slug={props.slug} id={props.id} type="strip" />
